import BarcodeReader from './barcode_reader.ts';
...
class EANReader extends BarcodeReader {
    constructor(opts, supplements) {
        super(merge(getDefaulConfig(), opts), supplements);
    }
...
Object.keys(properties).forEach(prop => {
    Object.defineProperty(EANReader, prop, properties[prop]);
});
