...
export function determineOtsuThreshold(imageWrapper, bitsPerPixel) {
    ...
    function determineThreshold() {
        const vet = [0]; let p1; let p2; let p12; let k; let m1; let m2; let m12;
...
export const Tracer = {
    trace(points, vec) {
        let iteration; const maxIterations = 10; let top = []; let result = []; let centerPos = 0; let
            currentPos = 0;

        function trace(idx, forward) {
            let from; let to; let toIdx; let predictedPos; const thresholdX = 1; const thresholdY = Math.abs(vec[1] / 10); let
                found = false;
